...
import '../../api/data_sources/remote/auth_remote_data_source_imp.dart'
    as _i275;
...
import '../../domain/repositories/category/product_repository.dart' as _i300;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i865.AuthRemoteDataSource>(
      () =>
          _i275.AuthRemoteDataSourceImp(webServices: gh<_i1069.WebServices>()),
    );
    ...
    gh.factory<_i300.ProductRepository>(
    ...
    gh.factory<_i939.GetAllProductsUseCase>(
      () => _i939.GetAllProductsUseCase(
        productRepository: gh<_i300.ProductRepository>(),
      ),
    );
    gh.factory<_i13.ProductTabViewModel>(
      () => _i13.ProductTabViewModel(
